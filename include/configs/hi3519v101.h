 ...
 *-----------------------------------------------------------------------*/
//lxc#define CONFIG_BOOTCOMMAND "bootm 0x81000000 0x82000000"
#define CONFIG_BOOTCOMMAND "mmc read 0 0x82000000 0x800 0x2800;bootm 0x82000000"
#define CONFIG_BOOTDELAY	1
//lxc #define CONFIG_BOOTARGS "mem=96M console=ttyAMA0,115200"
//lxc#define CONFIG_BOOTARGS "mem=64M console=ttyAMA0,115200 root=/dev/mtdblock2 rootfstype=jffs2 rw mtdparts=hi_sfc:1M(boot),5M(kernel),26M(rootfs)"
#define CONFIG_BOOTARGS "mem=64M console=ttyAMA0,115200 root=/dev/nfs nfsroot=192.168.1.5:/home/davis/workspace/nfsroot/rootfs rw ip=192.168.1.10:192.168.1.5:192.168.1.1:255.255.255.0"

//lxc#define CONFIG_NETMASK  255.255.255.0       /* talk on MY local net */
//lxc#define CONFIG_IPADDR   192.168.1.10        /* static IP I currently own */
//lxc#define CONFIG_SERVERIP 192.168.1.2     /* current IP of tftp server ip */
//lxc#define CONFIG_ETHADDR  00:00:23:34:45:66
