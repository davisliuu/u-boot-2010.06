...
//	uart_early_put_hex(0x1);
//	uart_early_putc(0xa);
//	uart_early_putc(0xd);

	hi3519_ddr_init();

//	uart_early_put_hex(0x2);
//	uart_early_putc(0xa);
//	uart_early_putc(0xd);
